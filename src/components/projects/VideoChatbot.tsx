    ...
    <div className="container max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <Card className="p-6 border border-border/50">
          ...
          <ul className="space-y-2 list-disc pl-5">
            <li>Created more engaging alternative to text-based chatbots for business services</li>
            <li>Maintained 24/7 availability while adding human element for trust and engagement</li>
            <li>Developed matching system for user queries and pre-recorded video responses</li>
            <li>Implemented advanced buffering and predictive loading to minimize video latency</li>
            <li>Built adaptive learning system to improve response accuracy over time</li>
          </ul>
        </Card>
      </div>
    </div>
